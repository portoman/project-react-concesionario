...
function UploadClient() {
    ...
    async function clickHandler() {
        const data = JSON.stringify({ DNI, nombre, apellidos, telefono, cpostal, ciudad });
        await post("http://localhost:3000/api" + "/client", data);
                        ...
                        <Col>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Stack direction="horizontal" gap={2}>
                                    ...
                                    <Form.Control type="text" onChange={nombreInputChangeHandler} />
                                </Stack>
                            </Form.Group>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Stack direction="horizontal" gap={2}>
                                    ...
                                    <Form.Control type="text" onChange={apellidosInputChangeHandler} />
                                </Stack>
                            </Form.Group>
                        </Col>
                        <Col>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Stack direction="horizontal" gap={2}>
                                    ...
                                    <Form.Control type="number" onChange={telefonoInputChangeHandler} />
                                </Stack>
                            </Form.Group>
                        </Col>
                    </Row>
                        ...
                        <Col>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Stack direction="horizontal" gap={2}>
                                    ...
                                    <Form.Control type="number" onChange={cpostalInputChangeHandler} />
                                </Stack>
                            </Form.Group>
                        </Col>
                        <Col>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Stack direction="horizontal" gap={2}>
                                    ...
                                    <Form.Control type="text" onChange={ciudadInputChangeHandler} />
                                </Stack>
                            </Form.Group>
                        </Col>
                    </Row>
